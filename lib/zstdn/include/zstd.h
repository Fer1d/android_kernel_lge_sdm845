 ...
 */
typedef ZSTDN_ErrorCode zstd_error_code;
 ...
 */
typedef ZSTDN_strategy zstd_strategy;
 ...
 * See zstd_lib.h.
 */
typedef ZSTDN_compressionParameters zstd_compression_parameters;
 ...
 */
typedef ZSTDN_frameParameters zstd_frame_parameters;
 ...
 */
typedef ZSTDN_parameters zstd_parameters;
 ...
 *                ZSTDN_compressBound(srcSize) is guaranteed to be large enough.
 ...
 * See zstd_lib.h.
 */
typedef ZSTDN_inBuffer zstd_in_buffer;
 ...
 * See zstd_lib.h.
 */
typedef ZSTDN_outBuffer zstd_out_buffer;

/* ======   Streaming Compression   ====== */

typedef ZSTDN_CStream zstd_cstream;
...
typedef ZSTDN_DStream zstd_dstream;
 ...
 *            Suitable to pass to ZSTDN_decompress() or similar functions.
 */
size_t zstd_find_frame_compressed_size(const void *src, size_t src_size);

/**
 * struct zstd_frame_params - zstd frame parameters stored in the frame header
 * @frameContentSize: The frame content size, or ZSTDN_CONTENTSIZE_UNKNOWN if not
 *                    present.
 ...
 * See zstd_lib.h.
 */
typedef ZSTDN_frameHeader zstd_frame_header;
